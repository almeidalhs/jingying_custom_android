...
import com.alan.codescanlibs.camera.CameraManager;
import com.alan.codescanlibs.decode.CaptureActivityHandler;
import com.alan.codescanlibs.decode.DecodeImageCallback;
import com.alan.codescanlibs.decode.DecodeImageThread;
import com.alan.codescanlibs.decode.DecodeManager;
import com.alan.codescanlibs.decode.InactivityTimer;
import com.alan.codescanlibs.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private LinearLayout mIvFlashLightLl;
    ...
    private void initView() {
        LinearLayout tvPic = (LinearLayout) findViewById(R.id.qr_code_header_black_pic);
        mIvFlashLightLl = (LinearLayout) findViewById(R.id.qr_code_iv_flash_light_ll);
        ...
        TextView back_tx = (TextView) findViewById(R.id.back_tx);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.qr_code_iv_flash_light_ll) {
...
//            }
    ...
    private void turnFlashlightOn() {
        ...
        mIvFlashLight.setBackgroundResource(R.mipmap.qrcode_icon_scan_led_on);
    ...
    private void turnFlashLightOff() {
        ...
        mIvFlashLight.setBackgroundResource(R.mipmap.qrcode_icon_scan_led);
