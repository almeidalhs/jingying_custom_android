...
/**
 * Created by tangbingliang on 16/11/29.
 */
...
public class GroundGlassUtil {
    ...
    public static Bitmap groundGlass17(Context context, Bitmap bkg, float radius) {
...
//        rs.destroy();
     ...
     */
    public static Bitmap groundGlass16(Bitmap sentBitmap, int radius) {
