...
import com.base.baselibs.widget.localalbum.common.StringUtils;
...
public class LocalAlbum extends BaseAppCompatActivity {
    ListView listView;
    ImageView progress;
...
//                            camera.setVisibility(View.VISIBLE);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if(LocalImageHelper.getInstance().getCurrentSize()+LocalImageHelper.getInstance().getCheckedItems().size()>=6){
